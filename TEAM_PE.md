...
Our team decided to finished all the tasks together and then incorporate our ideas.
...
1. Every team member should finish all the task together according to the suggested timeline.
2. Communicate with each other regularly to check if ideas are appropriate.
